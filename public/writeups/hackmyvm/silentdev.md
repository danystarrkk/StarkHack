...
![img1](images/Pasted%20image%2020251026184304.webp)
...
![img2](images/Pasted%20image%2020251026184555.webp)
...
![img3](images/Pasted%20image%2020251026184836.webp)
...
![img4](images/Pasted%20image%2020251026185155.webp)
...
![img5](images/Pasted%20image%2020251026185853.webp)
...
![img6](images/{77EBF70A-1AD8-4388-B847-2352DA5F991C}.webp)
...
![img7](images/{FC9089B9-42B0-41E7-A8E0-DA1AB0B315D7}.webp)

![img8](images/{F9959BE8-04F7-4ACA-B5D5-310686143167}.webp)

En sentido de tecnologías no vemos nada en especial.

Bueno para probar vamos a subir una imagen y ver que sucede:

![img9](images/{C2627CF3-0B6C-4143-886D-E36EBB3208E2}.webp)
...
![img10](images/{3007F2A9-D99A-4C7C-A34F-4EE4D85F83C7}.webp)
...
![img11](images/{C6FF9407-4C80-4632-9465-C0B83608DE45}.webp)
...
![img12](images/{DB272997-2AA6-4AA8-8D17-9FA8A3B9E0AC}.webp)

![img13](images/Pasted%20image%2020251026191338.webp)

![img14](images/Pasted%20image%2020251026191430.webp)

![img15](images/{CF2EA671-5399-41C4-854A-C092C03FC9D4}.webp)
...
![img16](images/Pasted%20image%2020251026191753.webp)
...
![img17](images/Pasted%20image%2020251026191954.webp)
...
![img23](images/Pasted%20image%2020251026194942.webp)
...
![img24](images/{66F4048E-240F-4B8F-9A6E-A61B1F91B6AE}.webp)
...
![img25](images/{0B133606-6E4C-4415-973E-2766AEBFB6BA}.webp)
...
![img26](images/Pasted%20image%2020251026195828.webp)
...
![img27](images/Pasted%20image%2020251026200427.webp)
...
![img28](images/Pasted%20image%2020251026200816.webp)
...
![img29](images/Pasted%20image%2020251026201418.webp)
...
![img30](images/Pasted%20image%2020251026201757.webp)
...
![img31](images/{80CDFC1A-C163-4653-8866-5C8DEA181400}.webp)
...
![img34](images/Pasted%20image%2020251026202758.webp)

Por último exportamos `xterm`:
![img35](images/Pasted%20image%2020251026202827.webp)

Ya con esto podemos intentar ver con `sudo -l` que comandos podemos usar sin necesidad de pasarle contraseña:

![img36](images/Pasted%20image%2020251026202957.webp)
...
![img37](images/{EECC81F8-22C4-48FA-92CA-F1C1145D7D44}.webp)
...
![img38](images/Pasted%20image%2020251026203358.webp)
...
![img42](images/Pasted%20image%2020251026204243.webp)

Al parecer el comando no lo tenemos. Vamos a traernos el binario a nuestra máquina para poder verlo:

![img43](images/{9ACA1B3A-2DB8-423D-A0D0-86A833BD4FE2}.webp)

Ya con esto le damos permisos de ejecución:

![img44](images/{7C02ACAF-101A-4EBA-9F68-52B8E43AA0EF}%201.webp)
...
![img45](images/{6C7BFDC8-93B6-4270-8A8F-1A6F0EFBAF8F}.webp)
...
![img46](images/{C69502AA-4EB4-4D48-9B8C-EA3257F2B39E}.webp)
...
![img47](images/{BA5B8E0D-260B-4154-BB30-6478FD64FE8E}.webp)

!Perfecto ya estamos como root, con esto ya podemos ver la flag del usuario root:

![img48](images/{1E5DF19B-2FD9-443A-B7C3-57F22F1B4310}.webp)

Con esto tenemos terminada la máquina.

![img49](images/{75D15725-A61A-46A5-B518-70391913AF43}.webp)
