...
![img1](images/Pasted%20image%2020251222162341.webp)
...
![img2](images/Pasted%20image%2020251222162741.webp)
...
![img3](images/Pasted%20image%2020251222163230.webp)
...
![img4](images/Pasted%20image%2020251222163342.webp)
...
![img5](images/Pasted%20image%2020251222163857.webp)

![img6](images/Pasted%20image%2020251222163930.webp)
...
![img7](images/{9C833D5B-66EE-44BC-B9A2-666F2C121EF7}.webp)
...
![img11](images/{591FF419-BD49-4C96-9742-1EF8A361A31F}.webp)

podemos observar que es diferente al usar `file`, veamos en BurpSuite que es lo que sale:

![img12](images/{C9F3C8C3-CFD9-4A39-89F4-DA32AEE2BEE2}.webp)
...
![img13](images/{4804A85C-7B97-44FE-84A4-0A3108ED6BFF}.webp)
...
![img14](images/{F7088DF2-D2B6-4FCF-8DCF-403A468CEFD9}.webp)

Excelente, vamos a analizar el código a ver que podemos hacer:

![img15](images/Pasted%20image%2020251224141012.webp)

Vemos que recibe también información por `POST`, con los parámetros `auth y payload`.

![img16](images/Pasted%20image%2020251224141140.webp)
...
![img17](images/Pasted%20image%2020251224141408.webp)

Bueno, algo pasa con el payload, veamos que hace la función `decrypt`:
![img18](images/Pasted%20image%2020251224141609.webp)
...
![img19](images/{1CC78D2A-4F3B-4480-B8FF-FE821664C7AF}.webp)

ahora eso vamos a enviarlo en payload a ver que logramos:

![img20](images/{BD90F666-190D-45E1-A2D2-6185BBFDD41E}.webp)
...
![img21](images/{9BA47F30-19F9-4CFF-8966-1006CDAF04CE}.webp)
...
![img22](images/{C9AD1B5E-9635-43CC-BF2E-6F7C2927B840}.webp)

![img23](images/{75D45F67-3041-4A13-80E7-3451D4B4717A}.webp)

Listo ya tenemos la Reverse Shell, vamos a darle tratamiento y comenzamos a enumerar:

![img24](images/{DBBF60DD-735F-4DDF-A0F0-70E1DE190E79}.webp)
...
![img25](images/{82CD5AA1-00D0-4342-A698-6C0E03ED706C}.webp)
...
![img26](images/{97FCB00B-3A13-498C-B9A0-3F2C5C413FCC}.webp)
...
![img31](images/Pasted%20image%2020251224152932.webp)
...
![img32](images/{0B86E75F-E9F1-45F5-83C5-E00B41808593}.webp)
...
![img33](images/{4AA6F875-6662-4BEE-92FC-F08AE36AB984}.webp)

se genera una nueva conversación donde vemos lo siguiente:

![img34](images/{0B935E4D-2A6A-4981-8EDD-EA9F2F8E5030}.webp)

veamos con números:

![img35](images/{126D3E36-F34A-47E6-97C9-BEAFAF1C2463}.webp)

![img36](images/{085EF87B-1B5E-44FA-806A-DD161B416D36}.webp)

vemos lo mismo, podemos intentar enviar mensajes en los diferentes chats a ver si en alguno el mensaje cambia:

![img37](images/{EE5439EE-9756-4542-B367-45220FA94212}.webp)

![img38](images/{2A1DF68D-FEDC-4B85-8908-9EF3A3AC29C1}.webp)
...
![img39](images/{E9850FA2-019E-4F49-8F52-59D6DDE1A1E4}.webp)

perfecto ahora volvemos a intentar con el mensaje del numero a ver que sucede:

![img40](images/{3A352884-B90C-4369-A2B6-35280D4D3F7E}.webp)

vemos lo mismo, intentamos con las demás salas a ver si alguna cambia:

![img41](images/{2B3268E6-B960-4D1A-8454-2DC62F582F0A}.webp)
...
![img42](images/{899A6D1E-E334-4B79-A6E1-645F8B20AE75}.webp)

intentemos con la `d` en format decimal que sería el `100`:

![img43](images/{3DBB7B58-560C-4DB7-BF68-67872EB7A3D0}.webp)

Esto funciona, enviemos combinaciones simples como `id` a ver si se ejecuta `105 100:)`:

![img44](images/{2224E7BF-A896-47B5-B376-7D27E9524B44}.webp)
...
![img45](images/{49D08AA1-5843-4687-B6CB-8409959E285B}.webp)

![img46](images/{A64FE51B-1877-463E-ADA4-A464B96D7DF9}.webp)

listo con esto ya podemos volver a generar una Reverse Shell para estar como el usuario `pycrtlake`:

![img47](images/{5711073E-EE85-443E-B791-94B4AE8B495C}.webp)
![img48](images/{630FC8BE-DC2C-429B-894D-B254A3256EDD}.webp)

Listo, ahora le damos tratamiento y comenzamos a enumerar.

![img49](images/{ABB7C062-0275-429B-B024-48CE392049F5}.webp)
...
![img50](images/{29C7FF23-FB5C-4C84-99A2-E022C4898A18}.webp)
...
![img51](images/{5DA118C3-9DD7-4E7A-AC1F-D330570A8C9C}.webp)

Tenemos la consola interactiva como `root`.

Ya podemos ver la flag:

![img52](images/{2B5443FC-8992-449F-9C3D-37776B6954B9}.webp)

Lab Terminado.
![img53](images/{A7276E19-2262-43C5-B31A-010F15E53D18}.webp)
