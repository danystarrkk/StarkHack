...
![img1](images/Pasted%20image%2020251022181804.png)
...
![img2](images/Pasted%20image%2020251022181919.png)
...
![img3](images/Pasted%20image%2020251022182404.png)
...
![img4](images/Pasted%20image%2020251022182710.png)
...
![img5](images/{5995BA3F-D558-4ED1-9C28-57433283EC32}.png)
...
![img6](images/Pasted%20image%2020251022183606.png)
...
![img7](images/Pasted%20image%2020251022185357.png)
...
![img8](images/Pasted%20image%2020251022185749.png)
...
![img9](images/{B11DB4AE-97BA-4514-AF36-21D33FB1837A}.png)
...
![img10](images/Pasted%20image%2020251023162240.png)
...
![img11](images/{632ACBF9-D02D-439F-8AEF-773CBBE18A5A}.png)
...
![img12](images/Pasted%20image%2020251023162803.png)
...
![img13](images/{BD51EE5B-76C7-4D56-BE66-28BE0E9841F2}.png)

Nos aplica un redirect:

![img14](images/{97931A7C-393E-493C-9465-BEB13516BB67}.png)
...
![img15](images/{8F2FEF78-FB17-41F6-94CE-939615C2B43F}.png)

Vemos que nos aplica un follow redirect:

![img16](images/{1D5FB8FE-9337-4222-ABA2-72E432992813}.png)
...
![img17](images/{15779616-E313-4A4B-A605-73E57308D0ED}.png)
...
![img18](images/{197736D1-7EE2-41F1-8BB4-5595F0BDACC7}.png)

Vemos un panel administrativo.

![img19](images/Pasted%20image%2020251023163842.png)
...
![img20](images/{0E646776-FBB6-4BA9-8157-59861C870012}.png)

Como vemos emplea el método `POST` por lo cual vamos a tener que usarlo de la siguiente manera:

![img21](images/Pasted%20image%2020251023170305.png)
...
![img22](images/{59B077A5-8E5D-410F-8E49-024131A3D666}.png)
...
![img23](images/Pasted%20image%2020251023185645.png)
...
![img24](images/Pasted%20image%2020251023191653.png)

# Escalada de Privilegios

Perfecto ya estamos dentro, lo que vamos a hacer ahora es un pequeño tratamiento a la terminal para manejarla mejor:

![img25](images/Pasted%20image%2020251023191807.png)
![img26](images/Pasted%20image%2020251023191827.png)

Perfecto, ahora lo que vamos a hacer es buscar en el sistema por otros usuarios:
![img27](images/{C3FB1DB5-BAEB-4108-BAB1-8CDBE2A1A590}.png)
...
![img28](images/{D9C785A4-A029-4D6A-AA71-A15466E2F221}.png)
...
![img29](images/{F3A7BCFB-C2F5-465A-A78C-DA9C44251CB6}.png)
...
![img30](images/{B20BA26B-659F-422E-AFBF-43F364F24334}.png)

Perfecto, vamos a ver la flag y a volver a listar los permisos de sudo:

![img31](images/{6248D655-2335-4497-B649-3993A29DF75A}.png)
...
![img32](images/Pasted%20image%2020251023192740.png)
...
![img33](images/{398B799A-CB54-4986-8184-D5B0EFD65D61}.png)
